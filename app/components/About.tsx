...
export default function About() {
  return (
  <section id="sobre" className="w-full bg-white scroll-mt-12 sm:scroll-mt-16" aria-labelledby="sobre-heading">
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="grid md:grid-cols-2 gap-8 items-center">
        <div>
          <h2 id="sobre-heading" className="text-2xl font-semibold mb-4">Sobre la empresa</h2>
            ...
            <div className="bg-gradient-to-br from-gray-100 to-white rounded-lg shadow-lg overflow-hidden w-full p-[2%]">
              ...
              <div className="aspect-[16/9] w-full">
                <div className="relative w-full h-full">
                        <Image 
                          src="/logo_banner.png" 
                          alt={`Logo de ${site.name} - Soluciones Integrales de Mantenimiento para Edificios y Empresas en Argentina y Chile`}
                          fill 

...
export default function Contact() {
  return (
  <section id="contacto" className="max-w-6xl mx-auto px-6 py-12 scroll-mt-12 sm:scroll-mt-16" aria-labelledby="contacto-heading">
      <div className="bg-blue-600 text-white rounded-lg p-8 flex flex-col md:flex-row items-center justify-between">
        <div className="text-center md:text-left">
          <h3 id="contacto-heading" className="text-xl font-semibold">¿Listo para empezar?</h3>
